const CONFIG = {
    circuiti: [
        ...
        { nome: 'South Garda (Lonato)', lat: 45.4384, lon: 10.4902, url: 'https://www.southgardakarting.it/', cal: 'https://racing.southgardakarting.it/calendario' }
    ],
    ...
    setup: {
        ...
        pos_spillo: ['5','4','3','2','1'],
        candela: ['NERA','NOCCIOLA','BIANCA']
    }
};